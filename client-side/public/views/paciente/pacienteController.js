 ...
 */
app.controller('pacienteCtrl', function($scope,$rootScope) {


    $rootScope.reqWithToken('/getFichasEvolucaoPorIdPaciente?idPaciente='+sessionStorage.getItem("ID"),sessionStorage.getItem("token"), 'GET', function (success) {
        console.log(success);
    }, function (err) {
        console.log(err);
    });
